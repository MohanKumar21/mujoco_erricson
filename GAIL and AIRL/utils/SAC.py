...
from .helper import soft_update, disable_gradient
from .base import Algorithm
from .buffer import Buffer
from .network import StateDependentPolicy, TwinnedStateActionFunction

class SAC(Algorithm):
    def __init__(self, state_shape, action_shape, device, seed, gamma = 0.99, batch_size = 256,
                 buffer_size = 10**6, lr_actor = 3e-4, lr_critic = 3e-4, lr_alpha = 3e-4, units_actor = (256,256),
        ...
        soft_update(self.critic, self.critic_target, 1.0)
    ...
    def update_critic(self, states, actions, rewards, dones, next_states, writer):
        ...
        with torch.no_grad():
            # print("ahhhhhhhhhhhhhh", next_states.shape)
